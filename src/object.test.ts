...
describe("ObjectSchema", () => {
	it("ObjectSchema.prototype.set", () => {
		...
		type _Check = Expect<typeof schema.type, { prop1: string; prop2?: string }>;
	...
	it("ObjectSchema.prototype.get", () => {
		...
		type _Check = Expect<
			typeof schema.type,
			{ prop1: string; prop2?: { prop21: string } }
		>;
		expect(
	...
	it("ObjectSchema.prototype.additionalProperties", () => {
		...
		type _Check = Expect<typeof schema.type, Record<string, unknown>>;
	...
	it("ObjectSchema.prototype.dependencies", () => {
		...
		type _Check = Expect<typeof schema.type, { some?: string; any?: string }>;
	...
	it("ObjectSchema.prototype.required", () => {
		...
		type _Check = Expect<typeof schema.type, { schemaR: { prop1: string } }>;
